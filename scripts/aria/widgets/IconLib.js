 ...
 * your template. It is useful for development and documentation.
 * @singleton
 */
    ...
    $prototype : {
        ...
        registerSprite : function (sprite) {
            ...
            if (aria.core.JsonValidator.normalize({
                json : sprite,
                beanName : "aria.widgets.CfgBeans.SpriteCfg"
            })) {
        ...
        /**
         * A method to remove a sprite from the iconLib. Shouldn't be allowed to delete aria-defined sprites. Declared
         * as internal for the moment.
         * @param {Object} name
        ...
        /**
         * Will return either false if the sprite and icon aren't in the library, or it returns an object with the
         * necessary information for building the markup inside the aria Icon object.
         * @param {String} sprite
         * @param {String} icon
        ...
        /**
         * This is used to catalogue all the icon sets and icons inside this library. There is no cfg object passed
         * through as is normal for other widgets. This shouldn't ever be called inside a real application, only as
         * documentation or during development.
        ...
        writeMarkup : function (out) {
            ...
            for (var sprite in this._sprites) {
                ...
                for (var icon in curSprite.content) {
                    ...
                    var background = curSprite.spriteURL
                            ? 'background:url(' + curSprite.spriteURL + ') no-repeat;'
                            : '';
                    var width = (curSprite.iconWidth < 600) ? 'width:' + (curSprite.iconWidth + 100) + 'px;' : '';
                    out.write(['<span style="display:inline-block;', width, '"><span ', cssClass, 'style="',
                            background, 'margin:1px;display:inline-block;width:', curSprite.iconWidth, 'px;height:',
                            curSprite.iconHeight, 'px;background-position:-', iconLeft, 'px -', iconTop,
                            'px;"></span> ', icon, '</span>'].join(''));
                }
                out.write('<br /><br/>');
            }
            curSprite = null;
